...
@section('content')
    <div class="container">
        <div class="card">
            <div class="card-header">@lang('messages.create.links')</div>
            <div class="body-card">
                @include('partitions.errors')
                <form method="post" action="{{ route('links.store') }}" enctype="multipart/form-data" class="col-md-6 mb-2">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input name="link" type="text" class="form-control" id="link" placeholder="@lang('messages.placeholder.title')" value="{{ old('title') }}">
                    </div>
                    <div class="form-group">
